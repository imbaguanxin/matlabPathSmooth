function [path_mat, imgResult] = astarNew(map, startPoint, endPoint, scoreFlag, logFileName, gridSize)
    ...
    while(~isempty(waitingList))
        ...
        for i = 1 : length(directionList)
            ...
            if (map.isBlank(nextPoint(1), nextPoint(2)))
                ...
                [score, h] = findScore(candi, nextPoint, endPoint, fatherH, scoreFlag);
                ...
                map.parent{nextPoint(1),nextPoint(2)} = [candi(1),candi(2)];
